...
class TestCode(unittest.TestCase):
    ...
    def test_saver(self):
        ...
        test_3 = requester.requester('https://www.w3schools.com/python/python_ref_functions.asp').extract_html()
        extracter_3 = extracter.extracter_from_w3(test_3['content'],index=True).extract_data()
        self.assertEqual(saver.saver('built_in_functions',index=True).save_data_into_file(extracter_3), True)